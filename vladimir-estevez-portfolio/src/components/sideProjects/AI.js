...
export const AIBasedProjects = {
    ...
    extendedDescription: 'As part of the Dawson College AI cohort, I completed comprehensive coursework on Machine Learning and Deep Learning fundamentals, including LLMs (Large Language Models), Linear Regression techniques, and essential Python programming skills. Our culminating assignment was to develop an AI Project Blueprint—a detailed guide outlining the methodology and considerations for implementing an AI solution to address real-world problems.\n\n' +
        ...
        '1) A Bitcoin price prediction system utilizing LSTM (Long Short-Term Memory) neural networks to forecast Bitcoin\'s market trends by analyzing historical price movements and trading volumes.\n\n' +
        ...
        'Both projects demonstrated how advanced AI techniques can significantly enhance predictive accuracy in volatile financial markets and complex real estate scenarios.\n\n' +
        'Our approach focused on adapting and implementing existing well-established models with carefully curated datasets sourced online, allowing us to concentrate on the practical applications and interpretations rather than algorithm development from scratch.\n\n' + ' The projects\' findings and insights were formally presented to faculty and peers at the Dawson College AI cohort, receiving positive feedback for their practical application of AI concepts.',
