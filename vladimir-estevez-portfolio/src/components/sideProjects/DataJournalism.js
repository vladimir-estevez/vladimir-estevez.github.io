...
export const DataJournalismChallenge = { 
    ...
    extendedDescription: 'Participated in and won two major awards at the DawsCon 2023 Data Journalism Challenge, examining the fairness of per capita emission statistics and identifying where climate change mitigation efforts should be focused.\r'
        ...
        + '\n\n'
        + 'Methodology:\n\n'
        + 'We utilized multiple CSV datasets (household emissions, industrial emissions, population counts) to generate DataFrames covering 2009-2019.\n\n'
        + 'After, we merged these DataFrames to compare total Canadian emissions and stationary combustion sources, using Python (pandas, seaborn, matplotlib) for data manipulation and visualization in Google Colab.\n\n'
        + 'Finally, stacked bar charts and line charts highlighted the difference between household emissions, industrial sources, and combined totals.\n\n'
        + '\n\n'
        + 'Key Findings and Recommendations:\n\n'
        + '• Identify the need to shift environmental debate focus to key industries\n\n'
        + '• Recommend stronger government regulations\n\n'
        + '• Emphasize the importance of public awareness about major emission sources\n\n'
        + '\n\n'
